                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cart__total">$ {{  $priceEnd}}</td>
                                        <td class="cart__close"> <a href="/carts/delete/{{ $product->id }}"><span class="icon_close"></span></a></td>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 offset-lg-2">
                        <div class="cart__total__procced">
                            ...
                            <a href="/carts/check" class="primary-btn">Proceed to checkout</a>
                        </div>
                    </div>
                </div>
            </div>
