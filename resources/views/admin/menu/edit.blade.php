      ...
      <form action="" method="POST">
        <div class="card-body demo-vertical-spacing demo-only-element">
            <div class="form-floating form-floating-outline mb-4">
              <input type="text" name="name" value="{{$menu->name}}" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
            ...
            <div class="form-floating form-floating-outline mb-4">
              <input class="form-control" name="description" value="{{ $menu->description }}" list="datalistOptions" id="exampleDataList" placeholder="Type to search...">
            ...
            <div class="form-floating form-floating-outline mb-4">
              <textarea class="form-control h-px-100" name="content" id="exampleFormControlTextarea1" placeholder="Comments here...">{{ $menu->content }}</textarea>
