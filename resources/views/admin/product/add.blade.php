      ...
      <form action="" method="POST">
        <div class="card-body demo-vertical-spacing demo-only-element">
            ...
            <div class="form-floating form-floating-outline mb-4">
              ...
              <div class="form-floating form-floating-outline mb-4">
                <input type="text" name="price_sale" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
              ...
              <div class="form-floating form-floating-outline mb-4">
                <input type="text" name="content" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
